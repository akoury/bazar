...
class AddProductsToCartTest extends TestCase
{
    ...
    public function a_user_can_add_different_products_to_his_cart()
    {
        ...
        $this->actingAs($user)->postJson(route('carts.store', $productA), ['quantity' => 3]);
    ...
    public function a_user_can_add_the_same_product_to_his_cart_multiple_times()
    {
        ...
        $this->postJson(route('carts.store', $product), ['quantity' => 1]);
        $this->actingAs($user->fresh())->postJson(route('carts.store', $product), ['quantity' => 1]);
        $this->actingAs($user->fresh())->postJson(route('carts.store', $product), ['quantity' => 1]);
    ...
    public function if_a_user_adds_more_products_than_remain_to_his_cart_at_different_times_the_remainder_is_added()
    {
        ...
        $this->postJson(route('carts.store', $product), ['quantity' => 1]);
        $this->actingAs($user->fresh())->postJson(route('carts.store', $product), ['quantity' => 2]);
    ...
    public function quantity_is_required_to_add_a_product_to_the_cart()
    {
        ...
        $response = $this->from(route('products.show', [$product->brand_id, $product]))->postJson(route('carts.store', $product), ['quantity' => '']);
    ...
    public function quantity_must_be_an_integer_to_add_a_product_to_the_cart()
    {
        ...
        $response = $this->from(route('products.show', [$product->brand_id, $product]))->postJson(route('carts.store', $product), ['quantity' => 1.3]);
    ...
    public function quantity_must_be_at_least_1_to_add_a_product_to_the_cart()
    {
        ...
        $response = $this->from(route('products.show', [$product->brand_id, $product]))->postJson(route('carts.store', $product), ['quantity' => 0]);
